locals {
  ...
  log_analytics_workspace_existing_resource_id     = var.log_analytics_workspace_resource_id != null ? var.log_analytics_workspace_resource_id : var.log_analytics_workspace_id
  log_analytics_workspace_id                       = local.deploy_container_app && var.log_analytics_workspace_creation_enabled ? module.log_analytics_workspace[0].resource_id : local.log_analytics_workspace_existing_resource_id
